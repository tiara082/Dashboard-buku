...
$columns = array(
    array(  'db' => 'id_penerbit', 'dt' => 'no' ),
    array(  'db' => 'nama_penerbit', 'dt' => 'nama' ),
    array(  'db' => 'email', 'dt' => 'email' ),
    array(  'db' => 'telp', 'dt' => 'telp' ),
    array(  'db' => 'alamat', 'dt' => 'alamat' ),
    array(  'db' => 'id_penerbit',
            'dt' => 'aksi',
            ...
            <center>
                <td class="text-center">
                    <a href="see_penerbit.php?id='.$d.'" class="btn btn-sm btn-light rounded-pill"><i
