...
<body>
    ...
    <section class="content">
        ...
        <?php
            ...
            $sql="SELECT * FROM perpus.buku INNER JOIN perpus.pengarang ON buku.id_pengarang=pengarang.id_pengarang INNER JOIN perpus.penerbit ON buku.id_penerbit=penerbit.id_penerbit INNER JOIN perpus.katalog ON buku.id_katalog=katalog.id_katalog WHERE buku.isbn ='$isbn'";
            $result=$conn->query($sql);
            $row=$result->fetch_assoc();
            ...
            <table class="table table-bordered " style="width:100%">
                <tr>
                    <th>ISBN :</th>
                    <td class="text-center" style="width:80%"><?php echo $isbn?></td>
                </tr>
                <tr>
                    <th>Judul :</th>
                    <td class="text-center"><?php echo $judul?></td>
                </tr>
                <tr>
                    <th>Penerbit :</th>
                    <td class="text-center"><?php echo $nama_penerbit?></td>
                </tr>
                <tr>
                    <th>Pengarang :</th>
                    <td class="text-center"><?php echo $nama_pengarang?></td>
                </tr>
                <tr>
                    <th>Katalog :</th>
                    <td class="text-center"><?php echo $nama_katalog?></td>
                </tr>
                <tr>
                    <th>Jumlah Koleksi :</th>
                    <td class="text-center"><?php echo $qty_stok?></td>
                </tr>
            </table>
        <a href="./index.php"  class="btn btn-primary rounded-0 px-4">Kembali</a>
