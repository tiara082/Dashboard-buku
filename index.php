        ...
        <ul class="side-bar">
            ...
            <ul class="navbar-nav ml-5">
                <li class="nav-item dropdown">
                    ...
                    <img src="<?=$value?>" alt="John Doe" width="40" class="border mp-1 rounded-circle">
                            <?php 
    ...
    <section class="content">
        ...
        <h1>Dashboard</h1>
            ...
            <div class="row align-items-center">
                    <div class="col-auto">
                        <a href="anggota/add_user.php" class="btn btn-primary rounded-0 px-3">
